  ...
  return (
    <div className='w-screen flex flex-col  items-center bg-fuchsia-100 p-14'>
        ...
        <div className='flex flex-col w-full h-60 border-dashed border-2 border-black rounded-2xl p-4 items-center gap-24'>
         <p className='mt-2 font-bold text-4xl '>Upload your file here</p>
          <label htmlFor='file-upload' className='border-black border-2 w-1/3 rounded-full px-2 py-1 text-base '>
            Browse
          </label>
          <input
          id='file-upload'
        ...
        <>
             ...
             <p onClick={()=>setPreview(null)} className='rounded-full px-2 bg-black text-white absolute cursor-pointer top-0 -right-8'>X</p>
        </>
        ...
        <p className='text-lg'>Product details</p>
          ...
          />
          <button onClick={handleSubmit(addproduct)} className='bg-red-500 text-white px-4 py-1 text-xl rounded-lg'>Add</button>
