...
async function deleteProduct(productId) {
    try {
        ...
        const response= await axios.post(`${baseURL}/delete-product/${productId}`)
        if(response){
            return response.data;
        }
        else return null;
...
async function editProduct(productId,data) {
    try {
        ...
        const response= await axios.patch(`${baseURL}/add-product/${productId}`,data)
        if(response){
            return response.data;
        }
        else return null;
...
async function getGenderBasedProduct(gender) {
    try {
        ...
        const response= await axios.get(`${baseURL}/get-product-gender/${gender}`)
        if(response){
        ...
        console.log("Error occured while getting product based on gender :: ",error)
    }
}
...
async function getCategoryBasedProduct(category) {
    try {
        ...
        const response= await axios.get(`${baseURL}/get-product-category/${category}`)
        if(response){
            return response.data;
        }
        else return null;
        ...
        console.log("Error occured while getting product based on category :: ",error)
    }
}
