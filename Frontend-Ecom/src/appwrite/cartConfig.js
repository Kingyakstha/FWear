...
const baseURL='http://localhost:8000/api/v1/carts'

async function addtoCart(productId,data) { 
    try {
        
        const response = await axios.post(`${baseURL}/add-cart/${productId}`,data,{
...
async function removefromCart(cartId) {
    try {
        ...
        console.log("Error occured while removing product from cart :: ",error)
    }
}
